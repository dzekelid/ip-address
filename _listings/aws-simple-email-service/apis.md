...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/ip-address/master/_listings/aws-simple-email-service/apis.md
specificationVersion: "0.14"
apis:
- name: AWS Simple Email Service API - Create Receipt Filter
  x-api-slug: actioncreatereceiptfilter-get
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/ip-address/master/_listings/aws-simple-email-service/actioncreatereceiptfilter-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/ip-address/master/_listings/aws-simple-email-service/actioncreatereceiptfilter-get-openapi.md
- name: AWS Simple Email Service API - Delete Receipt Filter
  x-api-slug: actiondeletereceiptfilter-get
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/ip-address/master/_listings/aws-simple-email-service/actiondeletereceiptfilter-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/ip-address/master/_listings/aws-simple-email-service/actiondeletereceiptfilter-get-openapi.md
- name: AWS Simple Email Service API - List Receipt Filters
  x-api-slug: actionlistreceiptfilters-get
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/ip-address/master/_listings/aws-simple-email-service/actionlistreceiptfilters-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/ip-address/master/_listings/aws-simple-email-service/actionlistreceiptfilters-get-openapi.md
x-common:
- type: x-api-gallery
