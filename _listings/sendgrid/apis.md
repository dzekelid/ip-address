...
- name: SendGrid - Get Access Settings Whitelist Rule
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/ip-address/master/_listings/sendgrid/access-settingswhitelistrule-id-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/ip-address/master/_listings/sendgrid/access-settingswhitelistrule-id-get-openapi.md
x-common:
- type: x--net-library
